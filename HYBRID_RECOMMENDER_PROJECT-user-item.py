...
# Make predictions for the user whose ID is given, using item-based and user-based recommendation methods.
# Take 5 propositions from the item-based model out of 5 user-based models and finally make 10 suggestions from 2 models.
...
movie=pd.read_csv(r"C:\Users\User\OneDrive\Masaüstü\veri bilimi\HybridRecommender-221114-235254\datasets\movie.csv")
movie.head()
movie.shape

# UserID, film adı, filme verilen oy ve zaman bilgisini içeren veri seti

rating=pd.read_csv(r"C:\Users\User\OneDrive\Masaüstü\veri bilimi\HybridRecommender-221114-235254\datasets\rating.csv")
rating.head()
rating.shape
